  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        // Trading specific
        profit: "border-transparent bg-primary/20 text-primary",
        loss: "border-transparent bg-destructive/20 text-destructive",
        pending: "border-transparent bg-warning/20 text-warning",
        funded: "border-transparent bg-primary text-primary-foreground font-bold animate-pulse",
        passed: "border-transparent bg-primary/30 text-primary",
